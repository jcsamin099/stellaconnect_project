  ...
  <nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white" id="sidenav-main">
    <div class="container-fluid">
      ...
      <a class="navbar-brand pt-0" href="dashboard.php">
                ...
                <img alt="Image paceholder" src="assets/img/theme/CICLOGO.png"> <i>Stella's Canteen</i>
        ...
        <ul class="navbar-nav">
         ...
         <!-- <li class="nav-item">
            <a class="nav-link" href="hrm.php">
              <i class="fas fa-user-tie text-warning"></i> HRM
            </a>
          </li>-->
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" href="products.php">
              <i class="ni ni-bullet-list-67 text-warning"></i>Products
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="orders.php">
              <i class="ni ni-cart text-warning"></i> Orders
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="payments.php">
              <i class="ni ni-credit-card text-warning"></i> Payments
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="receipts.php">
              <i class="fas fa-file-invoice-dollar text-warning"></i> Receipts
            </a>
          </li>
        </ul>
        <!-- Divider -->
