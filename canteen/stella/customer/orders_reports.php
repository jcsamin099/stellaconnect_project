                            ...
                            <table class="table align-items-center table-flush">
                                <thead class="thead-light">
                                    <tr>
                                        ...
                                        <th class="text-yellow" scope="col">Product</th>
                                        <th scope="col">Unit Price</th>
                                        <th class="text-yellow" scope="col">#</th>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="text-yellow"><?php echo $order->prod_name; ?></td>
                                            <td><?php echo $order->prod_price; ?></td>
                                            <td class="text-yellow"><?php echo $order->prod_qty; ?></td>
                                            ...
                                            <td class="text-yellow"><?php echo date('d/M/Y g:i', strtotime($order->created_at)); ?></td>
