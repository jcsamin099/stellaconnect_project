    ...
    if (empty($_POST["customer_phoneno"]) || empty($_POST["customer_name"]) || empty($_POST['customer_email'])) {
        ...
        if (isset($_FILES['profile_pic']) && $_FILES['profile_pic']['error'] == 0) {
            ...
            if (in_array($file_ext, $allowed_extensions)) {
                ...
                $upload_dir = "../admin/assets/img/theme/"; // Your upload directory

                if (move_uploaded_file($file_tmp, $upload_dir . $new_file_name)) {
                    // Update with new profile picture
                    $postQuery = "UPDATE rpos_customers SET customer_name = ?, customer_phoneno = ?, customer_email = ?, customer_profile_pic = ? WHERE customer_id = ?";
                    $postStmt = $mysqli->prepare($postQuery);
                    $rc = $postStmt->bind_param('sssss', $customer_name, $customer_phoneno, $customer_email, $new_file_name, $customer_id);
                    $postStmt->execute();
                } else {
                    $err = "Failed to upload profile picture.";
                }
            } else {
                $err = "Invalid file type. Only JPG, JPEG, PNG, GIF are allowed.";
            }
        } else {
            // No new profile picture uploaded - update without changing the picture
        ...
        if ($postStmt) {
            $success = "Profile Updated" && header("refresh:1; url=change_profile.php");
        } else {
                        ...
                        <div class="card card-profile shadow">
                            ...
                            <div class="card-body pt-0 pt-md-4">
                                ...
                                <div class="text-left">
                                    ...
                                    <div class="h4 font-weight-300">
                                        <i class="fas fa-credit-card mr-2"></i>Rewards: <?php echo $customer->rewards; ?>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <form method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="pl-lg-4">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12" style="display: none;">
                                                <div class="form-group">
                                                    ...
                                                    <input type="email" id="input-email"
                                                        ...
                                                        name="customer_email" class="form-control form-control-alternative">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-12">
                                                <div class="form-group">
                                                    <label class="form-control-label" for="profile-pic">Profile
                                                        Picture</label>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                <input type="submit" name="changeprof"
