                                        ...
                                        <div class="col-md-3 product-card mb-4">
                                            <div class="card text-center h-100">
                                                <?php if ($product['prod_img']) { ?>
                                                    <img src="../admin/assets/img/products/<?php echo $product['prod_img']; ?>"
                    ...
                    <div class="modal-body">
                        <form action="function.php" method="POST">
                            <div class="row">
                                ...
                                <div class="col-sm-2">
                                    <input type="text" name="customer_id" value="<?= $customer_id ?>" readonly
                                        id="customerID" class="form-control">
                                ...
                                <div class="col-sm-2">
                                    ...
                                    <input type="submit" id="checkoutButton" name="sub" class="btn btn-primary"
                                        value="Check Out">
                                </div>
                            </div>
                        </form>
