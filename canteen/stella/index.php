...
<body  class="bg-black" style="background-color:#F4F1EA;">
<div class="">
<div class="main-content">
    ...
    <div class="container mt--8 pb-5" >
      <div class="row justify-content-center">
        <div class="justify-content-center col-lg-5 col-md-7" style="background-color:rgba(255, 174, 0, 0.9);border-radius:15px;">
       <br>
       <br>
              ...
              <div class="form-group mb-3 " style="display: none;">
                  <div class="input-group input-group-alternative">
                   ...
                   <select name="logtype" id="logtype" class="form-control" required>   
                    <option value="2" class="">Student/Faculty</option>
                   </select>
                  </div>
                </div>
                ...
                <div class="custom-control custom-control-alternative custom-checkbox">
                  ...
                  <label class="custom-control-label" for=" customCheckLogin">
                    <span class="text-white" style="color: #fff;">Remember Me</span>
                  </label>
                </div>
