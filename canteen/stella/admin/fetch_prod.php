...
while ($row = $result->fetch_assoc()) {
    if($row['prod_img']){
        $row['prod_img'] = '<img src="assets/img/products/' . $row['prod_img'] . '" alt="Product Image" class="img-thumbnail" style="width: 60px; height: 60px;">';
    }else{
        $row['prod_img'] = "<img src='assets/img/products/default.jpg' height='60' width='60 class='img-thumbnail'>";
    }
