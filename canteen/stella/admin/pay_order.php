...
if (isset($_POST['pay'])) {
  ...
  //declare a varible which will be passed to alert function
  if ($upStmt && $postStmt) {
      $success = "Paid amount" && header("refresh:1; url=payments.php");
  } else {
      $err = "Please Try Again Or Try Later";
  }
...
<div class="form-row">
    <div class="col-md-6">
        ...
        <input type="text" name="pay_ref" id="pay_ref" class="form-control" placeholder="Enter Payment Reference Number">
    </div>
    <div class="col-md-6">
