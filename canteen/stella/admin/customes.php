          ...
          <div class="card shadow">
            <div class="card-header border-0 d-flex justify-content-between align-items-center">
              ...
              <form method="GET" class="form-inline">
                <input type="text" name="search" class="form-control mr-sm-2" placeholder="Search name..." value="<?php echo isset($_GET['search']) ? htmlspecialchars($_GET['search']) : ''; ?>">
                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                      ...
                      <td>
                        <button class="btn btn-sm btn-danger" onclick="confirmDelete('<?php echo $cust->customer_id; ?>')">
  ...
  function confirmDelete(customerId) {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        window.location.href = `customes.php?delete=${customerId}`;
      }
    });
  }
</script>
